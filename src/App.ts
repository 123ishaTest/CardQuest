        ...
        const game = new Game(
            {
                ...
                collection: new CardCollection([
                    ...
                    new CardPack(CardPackId.BronzeTierPack, [
                        ...
                        new Outcome<CardId>(CardId.LogCard, 2),
                        new Outcome<CardId>(CardId.BronzeOre, 2),
                        new Outcome<CardId>(CardId.SmallGrain, 2),
                        new Outcome<CardId>(CardId.BasicSword, 2),
                        new Outcome<CardId>(CardId.BronzeSword, 2),
                        new Outcome<CardId>(CardId.Bread, 2),
                    ]),
                    new CardPack(CardPackId.SilverTierPack, [
                        ...
                        new Outcome<CardId>(CardId.TreeCard, 2),
                        new Outcome<CardId>(CardId.SilverOre, 2),
                        new Outcome<CardId>(CardId.SilverSword, 2),
                        new Outcome<CardId>(CardId.CrackedShield, 2),
                        new Outcome<CardId>(CardId.ChaliceSmall, 2),
                    ]),
                    new CardPack(CardPackId.GoldTierPack, [
                        ...
                        new Outcome<CardId>(CardId.GoldOre, 1),
