<template>
  <div class="feature-tab">
    <p class="text-2xl font-semibold">How to play</p>
    <hr>
    ...
    <p class="text-lg">The Level plays cards at certain turns. These cards are known beforehand so you can build
    ...
    <br>
    <p class="text-lg">Whenever you perform an Action, the turn increases.</p>
    <p class="text-lg">The Level will Play certain Cards at certain turns</p>
    <br>
    <p class="text-lg">You can Play a card, to place it on the Field.</p>
    <p class="text-lg">Cards in the Field can be Tapped to interact with them.</p>
    <p class="text-lg">Cards can have costs to Play them, or Resources when they leave the Field (or both).</p>
    <p class="text-lg">You can use these Resources to upgrade your Tools and Weapons, or Play Action cards!</p>
    <br>
    <p class="text-lg">When you complete a Level, you gain some Cards to further improve your deck!</p>
    ...
    <p class="text-lg">Shift + 1-9 to Discard Cards</p>
